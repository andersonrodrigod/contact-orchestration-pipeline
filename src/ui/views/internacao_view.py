...
class InternacaoView(ctk.CTkFrame):
    def __init__(
        self,
        parent: ctk.CTkFrame,
        style: UIStyle,
    ...
    def _build(self) -> None:
        ...
        card_shadow.place(relx=0.5, rely=0.535, anchor="center")
        ...
        self.exec_status_label.grid(row=len(campos) + 2, column=0, columnspan=3, pady=(8, 12))
