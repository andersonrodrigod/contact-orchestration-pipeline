...
class UniaoStatusView(ctk.CTkFrame):
    MODES = (
        ("complicacao", "Uniao Complicacao"),
        ("internacao", "Uniao Internacao"),
    )
    ...
    def _build(self) -> None:
        ...
        title = ctk.CTkLabel(
            self,
            text="Uniao de Status e Flow de Respostas",
        ...
        fields = [
            ...
            ("arquivo_flow_resposta", "Flow de Respostas"),
            ("arquivo_saida", "Salvar arquivo unificado"),
        ]
        self._build_mode_frame(
            parent=content,
            mode="complicacao",
            fields=fields,
            execute_text="Executar Uniao",
        )
        self._build_mode_frame(
            parent=content,
            mode="internacao",
